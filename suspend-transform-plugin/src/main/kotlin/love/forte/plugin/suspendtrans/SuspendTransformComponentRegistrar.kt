...
import love.forte.plugin.suspendtrans.codegen.SuspendTransformCodegenExtension
...
class SuspendTransformComponentRegistrar(
    ...
    override fun registerProjectComponents(
        ...
        if (enabled) {
            ...
            ExpressionCodegenExtension.registerExtension(project, SuspendTransformCodegenExtension())
        }
    }
}
